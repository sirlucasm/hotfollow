        ...
        <div class="container-fluid" id="top">
            <nav class="row justify-content-between">
                ...
                <div class="edit-but-pos">
                    <button class="mr-lg-5 mr-md-4 mr-sm-4 mr-3 btn btn-outline mt-4" type="button" onclick="javascript: window.location='https://api.instagram.com/oauth/authorize/?client_id=93b6e05bdb4a4b0eb0558f32b93ecb97&redirect_uri=https://hotfollow.com.br/config/api/instagramLogin/callback.php&response_type=code';">Entrar</button>
                </div>
            </nav>
            ...
            <div class="edit-btn row justify-content-lg-start justify-content-md-start justify-content-sm-start justify-content-center ">
                <div class=" col-lg-4 mt-lg-3 ml-lg-5 col-md-4 ml-md-5 col-sm-6 mt-sm-3 ml-sm-5 col-9 mt-3">
                    <button type="button" onclick="javascript: window.location='https://api.instagram.com/oauth/authorize/?client_id=93b6e05bdb4a4b0eb0558f32b93ecb97&redirect_uri=https://hotfollow.com.br/config/api/instagramLogin/callback.php&response_type=code';" class="btn" data-toggle="button" aria-pressed="false" autocomplete="off" >Começar agora</button>
                </div>                    
            </div>
                ...
                <div class="card col-lg-6 col-sm-7">
                    ...
                    <div class="pos-text-card-part card-body">
                        ...
                        <div class="pos-main-btn edit-btn col-md-9">
                            <button type="button" onclick="javascript: window.location='https://api.instagram.com/oauth/authorize/?client_id=93b6e05bdb4a4b0eb0558f32b93ecb97&redirect_uri=https://hotfollow.com.br/config/api/instagramLogin/callback.php&response_type=code';" class="btn" data-toggle="button" aria-pressed="false" autocomplete="off" >Ganhar Seguidores Agora</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row list-group list-group-horizontal justify-content-md-center edit-howdo-text" align="center">
                <div class="col-md-5 col-lg-3 h-auto list-group-item" style="background:#ff7d38;">
                    ...
                    <h3>Login</h3>
                    <p>Faça o login com sua conta do instagram <a href="https://api.instagram.com/oauth/authorize/?client_id=93b6e05bdb4a4b0eb0558f32b93ecb97&redirect_uri=https://hotfollow.com.br/config/api/instagramLogin/callback.php&response_type=code">aqui</a> no <b>HotFollow</b>, na primeira vez logado aqui, você deve autorizar o acesso no aplicativo do Instagram, em "Fui eu".</p>
                </div>
                <div class="col-md-5 col-lg-3 h-auto list-group-item" style="background:#ff7d38;">
            ...
            <footer class="row edit-footer-part box-infos justify-content-center justify-content-lg-center justify-content-md-center">
                ...
                <ul class="col-md-2 col-lg-2 box-info-item" align="center">
                    <li><h3>Atalhos</h3></li>
                    <li><a href="https://api.instagram.com/oauth/authorize/?client_id=93b6e05bdb4a4b0eb0558f32b93ecb97&redirect_uri=https://hotfollow.com.br/config/api/instagramLogin/callback.php&response_type=code">Ganhar Seguidores/curtidas</a></li>
                    <li><p onclick="scrTopWhatDO();">O que fazer?</p></li>
                    <li><p onclick="scrTopAbout();">Sobre</p></li>
                </ul>
                <ul class="col-md-2 col-lg-2 box-info-item" align="center">
                    <li><h3>Informações</h3></li>
                    <li><a href="TermsUse.html">Termos de utilização</a></li>
                    <li><a href="PrivacyPolicy.html">Política de Privacidade</a></li>
                </ul>     
